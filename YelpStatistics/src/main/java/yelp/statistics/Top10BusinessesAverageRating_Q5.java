 ...
 */
public class Top10BusinessesAverageRating_Q5 {
	...
	public static void main(String[] args) throws Exception {
		...
		if (otherArgs.length != 2) {
			System.err.println("Usage: Top10BusinessesAverageRating_Q5 <in> <out>");
			System.exit(2);
		}

		Job job = Job.getInstance(conf, "Top 10 Ratings");
		job.setJarByClass(Top10BusinessesAverageRating_Q5.class);
