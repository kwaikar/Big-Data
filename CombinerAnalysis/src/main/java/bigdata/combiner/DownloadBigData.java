...
public class DownloadBigData {
	...
	public static String[] ebookArchiveUrls = { "http://www.utdallas.edu/~axn112530/cs6350/lab2/input/20417.txt.bz2",
...
if(args.length!=1)
	{
	System.out.println("Args expected : [FILE_OUTPUT_DIRECTORY]");
	}
			DownloadBigData.downloadAndUnzipFiles(ebookArchiveUrls,args[0]);
	 ...
	 * @return - FilePath of file downloaded
	 * @throws IOException
	 */
	public static String downloadAndUnzipFiles(String[] fileURLs,String destDir) throws IOException {
		...
		if (fs.exists(new Path(destDir))) {
			System.out.println("Directory already exists : Please provide alternate path");
		} else {
